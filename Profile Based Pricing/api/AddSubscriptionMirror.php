...
class AddSubscriptionMirror
{
	...
	{
		$callBackResult = $this->apiHelper->callPlatform("POST",$this->json["PLAN_ID"],json_encode($this->json),$this->json["ZGID"]);
		echo $callBackResult;
	}
...
$addSub = new AddSubscriptionMirror($request_body);
$addSub->setParameters();
$addSub->process();
?>